...
import { View, Text, FlatList, SafeAreaView, StyleSheet, ImageBackground, Image, Platform, Dimensions } from 'react-native';
        ...
        return (
            <View>
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    ...
                    <View>
                        <Text style={[styles.cardTitle, { marginTop: 150 }]}>
                            {item.name}
                        </Text>
                        <Text
